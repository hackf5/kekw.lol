...
int main(int argc, char* argv[]) {
    ...
    GLFWwindow* window = glfwCreateWindow(window_width, window_height, "kekw", NULL, NULL);
    if (window == NULL)
    {
    ...
    // TODO: this fails for non-ascii paths, converting from wide string to string seems like a total ball ache.
    // needs <windows.h> to be included and the WideCharToMultiByte should be called.
